...
#[cfg(feature = "batch")]
impl BatchErrorExt for libpep::errors::BatchError {
    fn display_prefix(&self) -> &'static str {
        ...
        match self {
            ...
            BatchError::DecryptionFailed { .. } => "DecryptionFailed",
            _ => "BatchError",
        }
    }
}
...
impl VerifyErrorExt for libpep::verifier::VerifyError {
    fn display_prefix(&self) -> &'static str {
...
#[cfg(feature = "verifiable")]
impl CacheRegistrationErrorExt for libpep::verifier::CacheRegistrationError {
    fn display_prefix(&self) -> &'static str {
        use libpep::verifier::CacheRegistrationError;
        match self {
...
#[cfg(feature = "verifiable")]
impl RegisterCommitmentsErrorExt for libpep::verifier::RegisterCommitmentsError {
    fn display_prefix(&self) -> &'static str {
        use libpep::verifier::RegisterCommitmentsError;
        match self {
...
#[cfg(feature = "batch")]
#[allow(dead_code)]
pub(crate) fn batch_err_to_js(e: libpep::errors::BatchError) -> JsValue {
    js_err(e.display_prefix(), &e)
}

#[cfg(feature = "verifiable")]
#[allow(dead_code)]
pub(crate) fn verify_err_to_js(e: libpep::verifier::VerifyError) -> JsValue {
    js_err(e.display_prefix(), &e)
}
