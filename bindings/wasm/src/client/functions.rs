...
pub fn wasm_encrypt_pseudonym(
    ...
    encrypt(
        &m.0,
        &PseudonymSessionPublicKey::from_point(public_key.0 .0),
        &mut rng,
    )
    .into()
}
...
pub fn wasm_decrypt_pseudonym(
    ...
    decrypt(
        &v.0,
        &PseudonymSessionSecretKey::from_scalar(secret_key.0 .0),
    )
    .map(|x| x.into())
}
...
pub fn wasm_encrypt_attribute(
    ...
    encrypt(
        &m.0,
        &AttributeSessionPublicKey::from_point(public_key.0 .0),
        &mut rng,
    )
    .into()
}
...
pub fn wasm_decrypt_attribute(
    ...
    decrypt(
        &v.0,
        &AttributeSessionSecretKey::from_scalar(secret_key.0 .0),
    )
    .map(|x| x.into())
}
...
pub fn wasm_encrypt_pseudonym_global(
    ...
    let mut rng = rand::rng();
    let key = PseudonymGlobalPublicKey::from_point(public_key.0 .0);
...
pub fn wasm_decrypt_pseudonym_global(
    ...
    let key = PseudonymGlobalSecretKey::from_scalar(secret_key.0 .0);
...
pub fn wasm_encrypt_attribute_global(
    ...
    let mut rng = rand::rng();
    let key = AttributeGlobalPublicKey::from_point(public_key.0 .0);
    encrypt_global(&m.0, &key, &mut rng).into()
}
...
pub fn wasm_decrypt_attribute_global(
    ...
    let key = AttributeGlobalSecretKey::from_scalar(secret_key.0 .0);
    decrypt_global(&v.0, &key).map(|x| x.into())
}
