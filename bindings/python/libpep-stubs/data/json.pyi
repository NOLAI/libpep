...
class EncryptedPEPJSONValue:
    ...
    def structure(self): ...
    def to_json(self): ...
    def transcrypt(self, from_domain, to_domain, from_session, to_session, pseudonymization_secret, encryption_secret, public_key=None, context=None): ...
...
def transcrypt_batch(values, transcryption_info, public_key=None):
    """Transcrypt a batch of EncryptedPEPJSONValues and shuffle their order."""
    ...

def transcrypt_json_batch(values, transcryption_info, public_key=None):
