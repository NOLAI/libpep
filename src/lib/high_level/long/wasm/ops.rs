use super::core::{WASMLongEncryptedAttribute, WASMLongEncryptedPseudonym};
...
#[cfg(not(feature = "elgamal3"))]
use crate::high_level::wasm::keys::{WASMAttributeSessionPublicKey, WASMPseudonymSessionPublicKey};
