...
#[cfg(not(feature = "elgamal3"))]
use crate::high_level::keys::{AttributeSessionPublicKey, PseudonymSessionPublicKey};
...
pub fn wasm_rerandomize_encrypted_pseudonym(v: &WASMEncryptedPseudonym) -> WASMEncryptedPseudonym {
    ...
    crate::high_level::rerandomize::rerandomize(&v.0, &mut rng).into()
}
...
pub fn wasm_rerandomize_encrypted_pseudonym(
    ...
    crate::high_level::rerandomize::rerandomize(&v.0, &pk, &mut rng).into()
}
...
pub fn wasm_rerandomize_encrypted_pseudonym_known(
    ...
    crate::high_level::rerandomize::rerandomize_known(&v.0, &RerandomizeFactor(r.0)).into()
}
...
pub fn wasm_rerandomize_encrypted_pseudonym_known(
    ...
    let pk = PseudonymSessionPublicKey(public_key.0 .0);
    crate::high_level::rerandomize::rerandomize_known(&v.0, &pk, &RerandomizeFactor(r.0)).into()
}
