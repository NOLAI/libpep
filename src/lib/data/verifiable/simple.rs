...
pub struct PseudonymPseudonymizationProof(pub crate::elgamal::verifiable::VerifiableRRSK);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
pub struct PseudonymRekeyProof(pub crate::elgamal::verifiable::VerifiableRekey);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
pub struct AttributeRekeyProof(pub crate::elgamal::verifiable::VerifiableRekey);
...
impl VerifiablePseudonymizable for EncryptedPseudonym {
        ...
        R: Rng + CryptoRng,
    {
        ...
        PseudonymPseudonymizationProof(crate::elgamal::verifiable::VerifiableRRSK::new(
            self.value(),
            &self.value().gy,
            &r,
            &info.s.0,
...
impl VerifiableRekeyable for EncryptedPseudonym {
    ...
    fn verifiable_rekey<R: Rng + CryptoRng>(
        ...
        PseudonymRekeyProof(crate::elgamal::verifiable::VerifiableRekey::new(
            self.value(),
            &info.k.0,
            rng,
        ))
...
impl VerifiableRekeyable for EncryptedAttribute {
    ...
    fn verifiable_rekey<R: Rng + CryptoRng>(
        ...
        AttributeRekeyProof(crate::elgamal::verifiable::VerifiableRekey::new(
            self.value(),
            &info.k.0,
            rng,
        ))
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
pub struct PseudonymPseudonymizationBatchProof(pub crate::elgamal::verifiable::VerifiableRRSKBatch);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
pub struct PseudonymRekeyBatchProof(pub crate::elgamal::verifiable::VerifiableRekeyBatch);
...
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
pub struct AttributeRekeyBatchProof(pub crate::elgamal::verifiable::VerifiableRekeyBatch);
...
impl crate::data::batch::EncryptedBatch<EncryptedPseudonym> {
        ...
        R: Rng + CryptoRng,
    {
        ...
        let proof = crate::elgamal::verifiable::VerifiableRRSKBatch::new(
        ...
        R: Rng + CryptoRng,
    {
        let originals: Vec<_> = self.items.iter().map(|e| *e.value()).collect();
        let proof =
            crate::elgamal::verifiable::VerifiableRekeyBatch::new(&originals, &info.k.0, rng);
        self.items = proof
            .result(&originals)
            .into_iter()
            .map(EncryptedPseudonym::from_value)
