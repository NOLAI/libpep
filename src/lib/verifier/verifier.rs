...
/// [`VerifiableRRSK`](crate::elgamal::verifiable::VerifiableRRSK) or
/// [`VerifiableRekey`](crate::elgamal::verifiable::VerifiableRekey) check against
/// these commitments.
pub struct Verifier {
