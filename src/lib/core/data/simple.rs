...
impl Encrypted for EncryptedPseudonym {
    ...
    fn decrypt(&self, secret_key: &Self::SecretKeyType) -> Option<Self::UnencryptedType> {
        crate::base::elgamal::decrypt(self.value(), secret_key.value()).map(Pseudonym::from_value)
    }
    ...
    fn rerandomize_known(&self, factor: &RerandomizeFactor) -> Self {
        EncryptedPseudonym::from_value(crate::base::primitives::rerandomize(
            self.value(),
            &factor.0,
        ))
    }
...
impl Encrypted for EncryptedAttribute {
    ...
    #[cfg(feature = "elgamal3")]
    fn decrypt(&self, secret_key: &Self::SecretKeyType) -> Option<Self::UnencryptedType> {
        crate::base::elgamal::decrypt(self.value(), secret_key.value()).map(Attribute::from_value)
    }
    ...
    #[cfg(feature = "elgamal3")]
    fn rerandomize_known(&self, factor: &RerandomizeFactor) -> Self {
        EncryptedAttribute::from_value(crate::base::primitives::rerandomize(
            self.value(),
            &factor.0,
        ))
    }
...
impl Pseudonymizable for EncryptedPseudonym {
    fn pseudonymize(&self, info: &PseudonymizationInfo) -> Self {
        EncryptedPseudonym::from_value(crate::base::primitives::rsk(
            self.value(),
            &info.s.0,
            &info.k.0,
        ))
...
impl Rekeyable for EncryptedPseudonym {
    ...
    fn rekey(&self, info: &Self::RekeyInfo) -> Self {
        EncryptedPseudonym::from_value(crate::base::primitives::rekey(self.value(), &info.0))
    }
}
...
impl Rekeyable for EncryptedAttribute {
    ...
    fn rekey(&self, info: &Self::RekeyInfo) -> Self {
        EncryptedAttribute::from_value(crate::base::primitives::rekey(self.value(), &info.0))
    }
}
...
#[cfg(feature = "batch")]
impl crate::core::batch::HasStructure for EncryptedPseudonym {
    type Structure = ();
...
#[cfg(feature = "batch")]
impl crate::core::batch::HasStructure for EncryptedAttribute {
    type Structure = ();
