...
#[cfg(feature = "long")]
use crate::core::wasm::data::long::{WASMLongEncryptedAttribute, WASMLongEncryptedPseudonym};
#[cfg(feature = "long")]
use crate::core::wasm::data::records::WASMLongRecordEncrypted;
use crate::core::wasm::data::records::WASMRecordEncrypted;
use crate::core::wasm::data::simple::{WASMEncryptedAttribute, WASMEncryptedPseudonym};
use crate::core::wasm::keys::WASMBlindingFactor;
...
pub struct WASMTranscryptor(Transcryptor);
...
impl WASMTranscryptor {
    ...
    pub fn transcrypt_json(
        &self,
        encrypted: &crate::core::wasm::data::json::WASMEncryptedPEPJSONValue,
        transcryption_info: &crate::core::wasm::contexts::WASMTranscryptionInfo,
    ) -> crate::core::wasm::data::json::WASMEncryptedPEPJSONValue {
        let transcrypted = self.transcrypt(&encrypted.0, &transcryption_info.0);
        crate::core::wasm::data::json::WASMEncryptedPEPJSONValue(transcrypted)
    }
    ...
    pub fn transcrypt_json_batch(
        &self,
        values: Vec<crate::core::wasm::data::json::WASMEncryptedPEPJSONValue>,
        transcryption_info: &crate::core::wasm::contexts::WASMTranscryptionInfo,
    ) -> Result<Vec<crate::core::wasm::data::json::WASMEncryptedPEPJSONValue>, wasm_bindgen::JsValue>
    {
        let mut rng = rand::rng();
        ...
        Ok(transcrypted
            .into_vec()
            .into_iter()
            .map(crate::core::wasm::data::json::WASMEncryptedPEPJSONValue)
            .collect())
    }
    ...
    pub fn transcrypt_record_batch(
        ...
        let mut rng = rand::rng();
        let mut rust_records: Vec<crate::core::data::records::EncryptedRecord> =
    ...
    pub fn transcrypt_long_record_batch(
        ...
        let mut rng = rand::rng();
        let mut rust_records: Vec<crate::core::data::records::LongEncryptedRecord> =
            records.into_iter().map(|r| r.into()).collect();
        let transcrypted = self
            .transcrypt_batch(&mut rust_records, &transcryption_info.0, &mut rng)
            .map_err(|e| wasm_bindgen::JsValue::from_str(&format!("{}", e)))?;
...
pub struct WASMDistributedTranscryptor(DistributedTranscryptor);
