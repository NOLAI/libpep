use crate::core::client::DistributedClient;
use crate::core::client::{Client, OfflineClient};
...
use crate::core::wasm::keys::WASMBlindedGlobalKeys;
...
pub struct WASMOfflinePEPClient(OfflineClient);
