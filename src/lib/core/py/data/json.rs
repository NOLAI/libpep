...
#[cfg(feature = "offline")]
use crate::core::py::keys::types::PyGlobalPublicKeys;
use crate::core::py::keys::types::{PyEncryptionSecret, PyPseudonymizationSecret};
#[cfg(all(feature = "insecure", feature = "offline"))]
...
pub fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    py.import("sys")?
        .getattr("modules")?
        .set_item("libpep.core.data.json.builder", &builder_module)?;
