use crate::core::client::make_session_keys_distributed;
use crate::core::client::Client;
#[cfg(feature = "offline")]
use crate::core::client::OfflineClient;
...
use crate::core::py::keys::shares::{PySessionKeyShares, PySessionPublicKeys, PySessionSecretKeys};
use crate::core::py::keys::types::{PyAttributeSessionKeys, PyPseudonymSessionKeys, PySessionKeys};
use crate::core::py::keys::{
    PyAttributeSessionPublicKey, PyAttributeSessionSecretKey, PyBlindedGlobalKeys,
    PyGlobalPublicKeys, PyPseudonymSessionPublicKey, PyPseudonymSessionSecretKey,
};
...
pub struct PyOfflineClient(OfflineClient);
