...
pub fn wasm_encrypt_json_global(
    ...
    let keys = GlobalPublicKeys {
        pseudonym: libpep::keys::ElGamalPublicKey::from_point(*global_keys.pseudonym().0),
        attribute: libpep::keys::ElGamalPublicKey::from_point(*global_keys.attribute().0),
    };
...
pub fn wasm_decrypt_json_global(
    ...
    let keys = libpep::keys::GlobalSecretKeys {
        pseudonym: libpep::keys::ElGamalSecretKey::from_scalar(global_secret_keys.pseudonym().0 .0),
        attribute: libpep::keys::ElGamalSecretKey::from_scalar(global_secret_keys.attribute().0 .0),
    };
    #[cfg(feature = "elgamal3")]
